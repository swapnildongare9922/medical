            ...
            <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
                <div class="main-navbar">
                    <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                        <a class="navbar-brand w-100 mr-0" href="/seller/home" style="line-height: 25px;">
                ...
                <div class="nav-wrapper">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('sidebar-home')" href="/seller/home">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('sidebar-orders')" href="/seller/orders">
