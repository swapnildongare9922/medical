...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">add district</span>
                    ...
                    <h6 class="m-0">Districts
                       <form action="" id="countryForm" method="POST">
                           ...
                           <div class="input-group">
                            <input type="text" class="form-control" id="newcountry" placeholder="New district"
                       ...
                       <small class="text-danger border-danger" id="countryError" hidden>District can not be null</small>
                    </h6>
                </div>
                        ...
                        <tbody>
                            @foreach ($district  as $item)
                                <tr>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-danger">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="/admin/home/district/delete/{{ $item->slug }}">
                                    ...
                                    <td>
                                        <a href="/admin/home/district/update/{{ $item->slug }}">
